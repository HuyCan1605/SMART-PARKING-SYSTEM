...
def preprocess(imgOriginal):
    ...
    # plt.title("maximal contrast gray scale")
    # plt.imshow(cv2.cvtColor(imgMaxContrastGrayscale, cv2.COLOR_BGR2RGB))
    # plt.show()
    ...
    # plt.title("gauss.jpg")
    # plt.imshow(cv2.cvtColor(imgBlurred, cv2.COLOR_BGR2RGB))
    # plt.show()
